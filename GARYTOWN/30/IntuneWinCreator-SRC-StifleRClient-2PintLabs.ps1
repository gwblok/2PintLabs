...
write-Host "========================================================================================"
Write-Host "Starting IntuneWinCreator-SRC-StifleRClient-2PintLabs.ps1" -ForegroundColor Green
write-Host "This will point the client at dr.2pintlabs.com" -ForegroundColor Magenta
write-Host "========================================================================================"
...
$SourceAppSettingsFile = "\\src\src$\Apps\2pint\Agent\Configs-2PintLabs\settings.2psImport"
...
$OutputAppPath = $SourceAppPath.Replace("Agent","AgentIntune2PintLabs")
...
if ($MSI) {
    ...
    write-Host "========================================================================================"
    Write-Host "Copying settings.2psImport for 2PintLabs.com to $SourceAppPath" -ForegroundColor Green
    write-Host "========================================================================================"
