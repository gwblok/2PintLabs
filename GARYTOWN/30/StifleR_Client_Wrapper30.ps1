...
$STIFLERSETTINGSURL = "https://raw.githubusercontent.com/gwblok/2PintLabs/refs/heads/main/GARYTOWN/30/dr2pintlabs.2psImport"
$ClientURL = 'https://dr.2pintlabs.com/3.0/StifleR-ClientApp.zip'
