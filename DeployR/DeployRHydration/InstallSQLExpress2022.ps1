...
'@
$username = "$env:ComputerName\BC Bob"
$password = ConvertTo-SecureString "P@ssw0rd" -AsPlainText -Force
$credential = New-Object System.Management.Automation.PSCredential ($username, $password)

$SQLInstall | Out-File $env:TEMP\SQLInstall.ps1 -Encoding UTF8 -Force
# Execute the generated form script
Start-Process pwsh.exe -ArgumentList "-NoProfile -ExecutionPolicy Bypass -File `"$env:TEMP\SQLInstall.ps1`"" -Wait -Credential $credential
